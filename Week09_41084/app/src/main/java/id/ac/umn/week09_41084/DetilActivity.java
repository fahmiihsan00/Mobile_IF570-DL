package id.ac.umn.week09_41084;
...
public class DetilActivity extends AppCompatActivity {
    ...
    public void simpanData(View view) {
        ...
        if(mNIM.length() <= 0 || mNama.length() <= 0 || mEmail.length() <= 0 || mNoHp.length() <= 0){
            ...
            Intent intentJawab = new Intent(); Mahasiswa mhs = new Mahasiswa(mNIM, mNama, mEmail, mNoHp);
            intentJawab.putExtra("MAHASISWA",mhs); setResult(RESULT_OK,intentJawab);
            finish();
        }
