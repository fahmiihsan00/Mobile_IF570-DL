package id.ac.umn.week10c_41084;
...
public class MainActivity extends AppCompatActivity {
    ...
    CustomBoundService customBoundService; boolean isBound = false; private ServiceConnection serviceConnection = new ServiceConnection() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShowTime.setOnClickListener(new View.OnClickListener() {
            ...
            @Override public void onClick(View v) {
                String currentTime = customBoundService.getCurrentTime(); Toast.makeText(getApplicationContext(), currentTime,Toast.LENGTH_LONG).show();
            }
        });
    }
}